...
- Node.js 24 or newer
- npm 11 or newer
- macOS, Windows, or Linux for development; v0.10.0 was packaged and smoke-tested on macOS arm64 and native Windows x64, with Linux x64 verified under Debian container emulation
