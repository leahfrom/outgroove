...
| ----------------------------------------------------------------- | ------------------------------- | ----------------------------------------------------------------------------------------- | --------------------------------------------------- |
| Strict TypeScript / lint / unit + temp integration tests          | Passed locally                  | Release CI configured                                                                     | PR and release CI configured                        |
| Forge package                                                     | Passed locally                  | Release CI configured, not manually verified                                              | PR and release CI configured, beta only             |
| Packaged launch + native SQLite worker + sandboxed renderer smoke | Passed locally                  | Release CI configured, not manually verified                                              | PR and release CI configured, not manually verified |
