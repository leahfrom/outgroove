...
- Store normalized and native tag views, technical properties, per-file failures, and incremental scan signatures in schema-v15 migrated SQLite.
...
- Name and save up to 100 active Library searches/views locally, including data-quality, album-artist, format, folder, and genre filters. Open them later from the keyboard-accessible Saved Library filters panel or delete them without affecting catalog or audio data.
