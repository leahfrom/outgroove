...
async function main(): Promise<void> {
  ...
  console.log(
    "Packaged app used an isolated profile, loaded the sandboxed renderer, scanned fixtures through discovery, metadata, and SQLite workers, verified a SQLite backup, and exited cleanly.",
  );
}
